...
namespace ServiceConsume.ServiceRef {
    using System;
    ...
    public partial class TestService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public TestService() {
            this.Url = global::ServiceConsume.Properties.Settings.Default.ServiceConsume_ServiceRef_TestService;
        ...
        /// <remarks/>
        public void InsertDetailAsync(string Date, string Event) {
            this.InsertDetailAsync(Date, Event, null);
        }
        
        /// <remarks/>
        public void InsertDetailAsync(string Date, string Event, object userState) {
            ...
            this.InvokeAsync("InsertDetail", new object[] {
                        Date,
                        Event}, this.InsertDetailOperationCompleted, userState);
        }
        ...
        public int UpdateDetail(int PersonID, string Date, string Event) {
        ...
        /// <remarks/>
        public void UpdateDetailAsync(int PersonID, string Date, string Event) {
            this.UpdateDetailAsync(PersonID, Date, Event, null);
        }
        
        /// <remarks/>
        public void UpdateDetailAsync(int PersonID, string Date, string Event, object userState) {
            ...
            this.InvokeAsync("UpdateDetail", new object[] {
                        PersonID,
                        Date,
                        Event}, this.UpdateDetailOperationCompleted, userState);
        }
